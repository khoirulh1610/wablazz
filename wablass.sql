...
CREATE TABLE `account`  (
  ...
  `level` enum('1','2') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT '2' COMMENT '1 = ADMIN\r\n2 = CS',
...
-- ----------------------------
INSERT INTO `pengaturan` VALUES (1, 100, 'http://127.0.0.1:8091', '081229193164', '498c0bb51e305e9c85b9f153fe356a39055d55c8', NULL);
...
CREATE TABLE `unsubscribe`  (
  ...
  `jalur` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `num`(`nomor`) USING BTREE
